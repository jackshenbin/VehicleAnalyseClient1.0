...
namespace AppUtil.Common
{
    public class TextUtil
    {
        ...
        public static bool ValidateTextLength(string input, bool allowNullorEmpty, string name, int minLength, int maxLength, out string msg)
        {
            bool bRet = false;
            msg = null;
