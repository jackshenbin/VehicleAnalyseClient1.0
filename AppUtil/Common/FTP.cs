...
namespace AppUtil.Common
{
    public class FtpWeb
    {
        ...
        public FtpWeb(string ip, string path, string userName, string password, Encoding enc)
        {
            m_ftpServerIP = ip;
        ...
        public FtpWeb(string ip, string path, string userName, string password)
            : this(ip, path, userName, password, Encoding.UTF8)
        {
        }
