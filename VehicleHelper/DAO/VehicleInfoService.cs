...
namespace VehicleHelper.DAO
{
    public class VehicleInfoService
    {
        ...
        //    {
        //        fileName = Path.Combine(System.Environment.CurrentDirectory, "车型", model.FrontPic.Trim("\r\n".ToCharArray()));
        //        if (File.Exists(fileName))
        //        {
        //            image = Image.FromFile(fileName);
        //        }
        //    }
        //    else if (!isFront && !string.IsNullOrEmpty(model.BackPic))
        //    {
        //        fileName = Path.Combine(System.Environment.CurrentDirectory, "车型", model.BackPic.Trim("\r\n".ToCharArray()));
        //        if (File.Exists(fileName))
        //        {
        //            image = Image.FromFile(fileName);
        //        }
